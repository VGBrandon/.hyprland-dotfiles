...
# Configurar hyprland.conf para comentar 'autogenerated = 1'
echo -e "${CYAN}Configurando Hyprland...${NC}"
sed -i 's/^autogenerated = 1/#autogenerated = 1/' ~/.config/hypr/hyprland.conf
echo -e "${GREEN}Hyprland configurado correctamente.${NC}"
...
sudo pacman -S --noconfirm neovim git neofetch waybar thunar font-manager tree curl zsh zsh-completions os-prober ntfs-3g tumbler ffmpegthumbnailer thunar-archive-plugin thunar-media-tags-plugin thunar-volman ark gvfs polkit-gnome stow
